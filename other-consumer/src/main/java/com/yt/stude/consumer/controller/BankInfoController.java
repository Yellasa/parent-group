...
public class BankInfoController
{
    ...
    public BankInfoDO findFeignById2(@PathVariable("id")Long id) {
        return restTemplate.getForObject("http://SERVICE-B/provider/api/v1/mysb/{1}",BankInfoDO.class,id);
    ...
    public String findBankInfoSucessHystrix(@PathVariable("id") Long id){
        return restTemplate.getForObject("http://SERVICE-B/provider/api/v1/mysb/{1}",BankInfoDO.class,id).toString();
    }
